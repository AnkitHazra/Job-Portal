...
function DashboardLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="fixed top-0 left-0 right-0 z-60 mb-20 flex items-center justify-between border-b border-slate-800/50 bg-slate-950/60 backdrop-blur-xl p-4 md:hidden">
