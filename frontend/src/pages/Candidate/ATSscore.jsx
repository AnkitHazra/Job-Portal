        ...
        >
            ...
            {result?.aiSuggestions && (
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 1 }}
                    className="mt-8 rounded-2xl border border-purple-500/20 bg-purple-500/5 backdrop-blur-sm p-6 sm:p-8 shadow-xl"
                >
                    <div className="flex items-center gap-3 mb-6">
                    ...
                    {/* Improvement Tips */}
                    <div className="mt-6">
                        <h3 className="text-sm font-semibold text-blue-400 mb-3">Actionable Tips</h3>
                        <div className="space-y-2">
                            {result.aiSuggestions.improvementTips?.map((tip, i) => (
                                <motion.div
                                    key={i}
                                    initial={{ opacity: 0, x: -10 }}
                                    animate={{ opacity: 1, x: 0 }}
                                ...
                                >
                                    <span className="shrink-0 h-5 w-5 rounded-full bg-blue-500/10 text-blue-400 flex items-center justify-center text-xs font-bold">
                                        {i + 1}
                                    </span>
                    ...
                    {/* Recommended Jobs */}
                    <div className="mt-6">
                        <h3 className="text-sm font-semibold text-amber-400 mb-3">Recommended Jobs</h3>
                        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                            {result.aiSuggestions.recommendedJobs?.map((job, i) => (
                                <motion.div
                                    key={i}
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        <span className="text-xs text-amber-400">{job.matchPercentage}%</span>
                                    </div>
                                    <p className="text-xs text-slate-400 mt-2">{job.reason}</p>
                                </motion.div>
                            ))}
                        </div>
                    </div>
                    ...
                    {/* Skills to Add */}
                    <div className="mt-6">
                        <h3 className="text-sm font-semibold text-emerald-400 mb-3">Skills to Develop</h3>
                        <div className="flex flex-wrap gap-2">
                            {result.aiSuggestions.skillsToAdd?.map((skill, i) => (
                                <span
                                    key={i}
                                    className="rounded-lg bg-emerald-500/10 border border-emerald-500/20 px-3 py-1.5 text-xs font-medium text-emerald-400"
                                >
                                    {skill}
                                </span>
                            ))}
