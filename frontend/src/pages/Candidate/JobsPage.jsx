...
function JobsPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Browse Jobs | Hirevity</title>

        <meta
          name="description"
          content="Discover full-time, part-time, internship, and remote opportunities with Hirevity. Explore AI-powered job recommendations and apply to your next role."
        />
        ...
        <link
          rel="canonical"
          href="https://job.ankithazra.online/jobs"
        />
      </Helmet>
      <motion.div
        initial={{ opacity: 0 }}
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <motion.button
                  ...
                  className={`inline-flex items-center justify-center gap-2 rounded-xl border px-5 py-3.5 text-sm font-medium transition-all ${isFiltersVisible
