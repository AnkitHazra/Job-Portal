...
function RegisterPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Sign Up | Hirevity</title>
        <meta
          name="description"
          content="Sign Up to Hirevity to track applications, manage jobs, and access AI-powered ATS insights."
        />
        <meta
          name="keywords"
        ...
        <link
          rel="canonical"
          href="https://job.ankithazra.online/register"
        />
      </Helmet>
                ...
                {formData.password && (
                  ...
                  >
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <p className={`text-xs font-medium ${passwordStrength.label === "Weak" ? "text-rose-400" :
              ...
              >
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="••••••••"
                    className={`w-full rounded-xl border bg-slate-800/50 pl-4 pr-12 py-3 text-sm text-white placeholder-slate-500 transition-all focus:outline-none focus:ring-2 ${formData.confirmPassword
                      ? passwordsMatch
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <motion.button
                    ...
                    className={`relative flex flex-col items-center gap-3 rounded-xl border p-4 transition-all ${formData.role === "candidate"
                  ...
                  >
                    <div
                      className={`rounded-xl p-2.5 ${formData.role === "candidate"
                        ? "bg-blue-500/20"
                        : "bg-slate-700/50"
                        }`}
                    >
                  ...
                  <motion.button
                    ...
                    className={`relative flex flex-col items-center gap-3 rounded-xl border p-4 transition-all ${formData.role === "recruiter"
                      ? "border-purple-500/50 bg-purple-500/10 text-purple-400 shadow-lg shadow-purple-500/10"
                      : "border-slate-700/80 bg-slate-800/50 text-slate-400 hover:border-slate-600"
                      }`}
                  >
                    <div
                      className={`rounded-xl p-2.5 ${formData.role === "recruiter"
                        ? "bg-purple-500/20"
                        : "bg-slate-700/50"
                        }`}
                    >
